...
('''function HeaderStat({ icon, label, value, href, showViewIcon = false }: { icon: IconName; label: string; value: string; href?: string; showViewIcon?: boolean }) {
...
('''function portalLabel(value: string | undefined) { if (value === "invited") return "Portal User Invited"; if (value === "active") return "Portal User Active"; if (value === "suspended") return "Portal User Suspended"; return "Portal User Not Created"; }''','''function portalLabel(value: string | undefined) { if (value === "invited") return "Portal User Invited"; if (value === "active") return "Portal User Active"; if (value === "suspended") return "Portal User Suspended"; return "Portal User Not Created"; }
...
for old, new in replacements:
    if old not in text:
        raise SystemExit('Expected source block not found; refusing to patch')
