...
- **2026-09-24 — Revert Reports Overview PR #2307:** branch `revert/pr-2307-reports-overview-20260924`; restores the Reports Overview files to their pre-#2307 state and removes the two client controls introduced by #2307. Because PR #2308 only fixed #2307's period-helper/typecheck code, its related management-pack changes are also removed by restoring the pre-#2307 file. No database/schema/mobile/APK change. **IMPLEMENTED; PR #2314; CI green; merge/deployment pending.**
