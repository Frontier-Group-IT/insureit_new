...
- **2026-09-24 — Reports Overview controls + interactive trend:** branch `feat/reports-overview-period-dropdown`; removes the Overview Filters button; adds report-period MTD / Last Month / Last 6 Months / Custom with custom date modal and outside-click/Escape dismissal; adds All Business / Motor / Non Motor / Life / Health filtering for supported business/finance report data; and adds an independent Business Trend selector defaulting to Last 6 Months with MTD / Last Month daily timelines, Last 6 Months / 1 Year monthly timelines, plus hover data labels for Net Premium and Policies. Management Pack export preserves the selected report period and business scope. No schema, migration, RLS, permission, APK/AAB, or native-runtime change. **IMPLEMENTED; PR #2324 open; CI/merge/deployment pending.**
