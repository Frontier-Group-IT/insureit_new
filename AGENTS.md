...
- **2026-09-24 — Reports Business Mix policy counts + 60-day renewal opportunity:** branch `refine/reports-business-mix-policy-count-renewal-60d`; Business Mix keeps Net Premium as the bar metric, shows the premium value as a data label above each bar, replaces the former amount-at-right position with a **Policies** column using policy count, and keeps Share unchanged for By Insurer / By RM / By Source. Renewal Opportunity now extends to a non-overlapping Within 60 Days bucket (31–60 days), fetches a 60-day horizon, and shows policy count above every bar. No schema, migration, RLS, permission, APK/AAB, or native-runtime change. **IMPLEMENTED; PR/CI/merge/deployment pending.**
