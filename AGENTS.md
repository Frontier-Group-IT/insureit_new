...
- **2026-09-24 — Tata Commercial renewal voice v11 opening + unlimited campaign upload:** branch `fix/sarvam-v11-opening-unlimited-campaign-main`; removes the stale website-generated Tata opening sentence, replaces first-call wording with the concise v11-compatible renewal opening, removes the fixed 100/500 source-row ceiling from parser/UI/schema, and keeps file-size validation plus all existing IT-only calling safeguards. Prior Tata Renewal workflow PR #2353 was merged/deployed with its schema applied; this follow-up migration `20260924173500_remove_voice_campaign_row_limit.sql` is **IMPLEMENTED; PR/CI/merge/application/deployment pending.** See `docs/SARVAM_TATA_COMMERCIAL_RENEWAL_2026_09_24.md`.
