...
- **2026-09-18 — Sarvam webhook retry pending-state semantics:** branch `fix/sarvam-webhook-retry-pending-state`; live HTTP 202 evidence proved provider acceptance does not equal callback delivery. Voice Integration now labels 202 as **queued by Sarvam / delivery unverified** until INSUREIT actually observes the callback. **IMPLEMENTED; CI/merge/deployment pending.** See `docs/SARVAM_WEBHOOK_RECOVERY_2026_09_18.md`.
