...
- **2026-09-24 — Reports Overview period selector:** branch `feat/reports-overview-period-dropdown`; removes the Overview Filters button, turns the MTD control into MTD / Last Month / Last 6 Months / Custom period selection, adds a compact custom From/To date modal with OK, Escape and click-outside close behavior, and applies the selected range to period-dependent Overview report data and Management Pack export. No schema, migration, RLS, permission, APK/AAB, or native-runtime change. **IMPLEMENTED; PR/CI/merge/deployment pending.**
