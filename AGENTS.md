...
- **2026-09-18 — Sarvam Phase A operational calling policy:** branch `feat/sarvam-operational-calling-policy`; INSUREIT enforces a server-side 09:00–18:00 Asia/Kolkata calling window before creating an attempt, keeps DNC/terminal guards authoritative, and keeps app-level automatic retry disabled. **IMPLEMENTED; CI/merge/deployment pending.** See `docs/SARVAM_OPERATIONAL_CALLING_POLICY_2026_09_18.md`.
