        ...
        {selectedPolicy ? (
          <View style={styles.policyCard}>
            ...
            <View style={styles.modeRow}>
              <MaterialCommunityIcons name={selectedPolicy.source === 'external' ? 'account-edit-outline' : 'account-tie-outline'} size={17} color={selectedPolicy.source === 'external' ? '#0A43A3' : '#087443'} />
...
const styles = StyleSheet.create({
  header: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, marginBottom: 18 }, backButton: { width: 44, height: 44, borderRadius: 14, borderWidth: 1, borderColor: '#DCE6F0', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, headerCopy: { flex: 1, minWidth: 0 }, eyebrow: { color: '#0A43A3', fontSize: 10, fontWeight: '900', letterSpacing: 0.9 }, title: { color: palette.navy, fontSize: 22, lineHeight: 27, fontWeight: '900', marginTop: 2 }, subtitle: { color: '#667085', fontSize: 11.5, lineHeight: 16, fontWeight: '600', marginTop: 4 },
  section: { marginBottom: 16 }, sectionHeading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginBottom: 8 }, sectionLabel: { color: palette.navy, fontSize: 13, fontWeight: '900' }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, chip: { minHeight: 42, maxWidth: 190, justifyContent: 'center', borderRadius: 999, borderWidth: 1, borderColor: '#D6E2F0', backgroundColor: '#FFFFFF', paddingHorizontal: 13 }, chipActive: { backgroundColor: palette.navy, borderColor: palette.navy }, chipText: { color: '#56657A', fontSize: 11, fontWeight: '800' }, chipTextActive: { color: '#FFFFFF' },
  vehicleField: { gap: 6 }, selectButton: { minHeight: 58, borderRadius: 14, borderWidth: 1, borderColor: '#D7E0EA', backgroundColor: '#FFFFFF', paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 9 }, selectIcon: { width: 36, height: 36, borderRadius: 11, backgroundColor: '#EEF5FF', alignItems: 'center', justifyContent: 'center' }, selectCopy: { flex: 1, minWidth: 0 }, selectValue: { color: palette.navy, fontSize: 14, fontWeight: '900' }, selectMeta: { color: '#7A8799', fontSize: 10.5, fontWeight: '600', marginTop: 2 }, placeholder: { color: '#7A8798', fontWeight: '700' }, makeMenu: { borderRadius: 14, borderWidth: 1, borderColor: '#DCE8F4', backgroundColor: '#FFFFFF', overflow: 'hidden', marginTop: 5 }, makeSearch: { minHeight: 46, backgroundColor: '#F8FBFF', borderBottomWidth: 1, borderBottomColor: '#E8EFF7', paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 7 }, makeSearchInput: { flex: 1, minHeight: 44, color: palette.navy, fontSize: 12.5, fontWeight: '600' }, makeOption: { minHeight: 54, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#EEF2F6' }, selectOptionActive: { backgroundColor: '#EEF5FF' }, selectOptionText: { color: '#607089', fontSize: 12, fontWeight: '800' }, selectOptionTextActive: { color: palette.navy, fontWeight: '900' }, vehicleOptionCopy: { flex: 1, minWidth: 0 }, optionMeta: { color: '#8A94A6', fontSize: 10.5, fontWeight: '600', marginTop: 2 }, emptyLookupText: { color: '#7A8799', fontSize: 11, fontWeight: '700', paddingHorizontal: 11, paddingVertical: 13 },
  addPolicyButton: { minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 11, borderWidth: 1, borderColor: '#C9DAF2', backgroundColor: '#F7FAFF', paddingHorizontal: 10 }, addPolicyText: { color: '#0A43A3', fontSize: 10.5, fontWeight: '900' }, policyCard: { borderRadius: 16, borderWidth: 1, borderColor: '#DCE6F0', backgroundColor: '#FFFFFF', padding: 12 }, policyTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, policyIcon: { width: 44, height: 44, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, policyIconExternal: { backgroundColor: '#EEF5FF' }, policyIconManaged: { backgroundColor: '#EAF8F0' }, policyCopy: { flex: 1, minWidth: 0 }, insurerName: { color: palette.navy, fontSize: 13.5, fontWeight: '900' }, policyNo: { color: '#344054', fontSize: 11, fontWeight: '800', marginTop: 2 }, policyMeta: { color: '#7A8799', fontSize: 10, lineHeight: 14, fontWeight: '600', marginTop: 2 }, modeRow: { marginTop: 11, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#EEF2F6', flexDirection: 'row', alignItems: 'flex-start', gap: 8 }, modeCopy: { flex: 1, minWidth: 0 }, modeTitle: { color: palette.navy, fontSize: 11.5, fontWeight: '900' }, modeText: { color: '#667085', fontSize: 10.5, lineHeight: 15, fontWeight: '600', marginTop: 2 },
