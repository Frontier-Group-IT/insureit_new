...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  body: { flexGrow: 1, paddingHorizontal: 12, paddingTop: 7, paddingBottom: 92, gap: 8 },
  ...
  fleetCard: { minHeight: 150, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8E7F7', paddingHorizontal: 10, paddingTop: 10, paddingBottom: 9, overflow: 'hidden', shadowColor: '#122544', shadowOpacity: 0.06, shadowRadius: 10, elevation: 2 },
  fleetTop: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  fleetMainRow: { minHeight: 82, flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 3 },
  fleetCountBlock: { width: 78, minWidth: 78, alignItems: 'center', justifyContent: 'center', paddingLeft: 2 },
  fleetCount: { color: palette.navy, fontSize: 35, lineHeight: 39, fontWeight: '900' },
  ...
  fleetImageHero: { flex: 1, height: 84, marginLeft: -8, marginRight: -5, opacity: 0.95 },
  ...
  fleetTicker: { minHeight: 28, marginTop: 4, paddingHorizontal: 1, flexDirection: 'row', alignItems: 'center', gap: 6 },
  ...
  claimSummaryCard: { minHeight: 142, borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8E7F7', overflow: 'hidden', shadowColor: '#071D49', shadowOpacity: 0.08, shadowRadius: 10, elevation: 2 },
  claimSummaryTop: { backgroundColor: palette.navy, paddingHorizontal: 12, paddingTop: 11, paddingBottom: 10 },
  ...
  claimMetric: { flex: 1, minHeight: 68, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6 },
  claimMetricDivider: { width: StyleSheet.hairlineWidth, backgroundColor: 'rgba(255,255,255,0.18)', marginVertical: 9 },
  claimMetricValue: { fontSize: 23, lineHeight: 27, fontWeight: '900' },
  ...
  claimTicker: { minHeight: 29, marginHorizontal: 10, marginTop: 4, marginBottom: 6, paddingHorizontal: 1, flexDirection: 'row', alignItems: 'center', gap: 7 },
  ...
  supportCard: { paddingHorizontal: 2, paddingTop: 6, paddingBottom: 0 },
  ...
  supportButton: { flex: 1, minHeight: 54, alignItems: 'center', justifyContent: 'center', gap: 5 },
  ...
  appVersion: { color: '#A6B3C6', fontSize: 9.5, fontWeight: '700', textAlign: 'center', marginTop: 'auto', paddingTop: 18, paddingBottom: 1 },
