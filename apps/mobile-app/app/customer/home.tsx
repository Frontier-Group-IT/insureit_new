...
export default function CustomerMockupHomeScreen() {
  ...
  return <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.actionCard}><ActionTile icon="calendar-month-outline" title="Renewal Dues" body="View and pay your policy renewals" onPress={() => router.push('/customer/policies')} tone="orange" /><View style={styles.actionDivider} /><ActionTile icon="file-document-outline" title="Get Quote" body="Get a quote for new insurance" onPress={() => router.push('/customer/insurance-quote')} tone="blue" /><View style={styles.actionDivider} /><ActionTile imageSource={exchangeVehicleIcon} title="Exchange Vehicle" body="Exchange your old vehicle for a new one" onPress={() => router.push('/customer/support')} tone="green" /></View>
...
const styles = StyleSheet.create({
  ...
  header: { height: 78, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: 'rgba(255,255,255,0.98)', borderBottomWidth: 1, borderBottomColor: '#E1E7F0' }, brand: { flex: 1, alignItems: 'flex-start', justifyContent: 'center' }, iconCircle: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center' }, avatar: { width: 42, height: 42, borderRadius: 21, backgroundColor: palette.ink, borderWidth: 2, borderColor: 'rgba(255,255,255,0.92)', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: '#FFFFFF', fontWeight: '900', fontSize: 17 },
  ...
  actionCard: { minHeight: 116, borderRadius: 17, backgroundColor: '#FFFFFF', flexDirection: 'row', paddingVertical: 11, shadowColor: '#122544', shadowOpacity: 0.06, shadowRadius: 10, elevation: 2 }, actionTile: { flex: 1, alignItems: 'center', paddingHorizontal: 6 }, actionIcon: { width: 39, height: 39, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, actionImageIcon: { width: 34, height: 34 }, actionTitleRow: { minHeight: 30, marginTop: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }, actionTitle: { flex: 1, color: palette.navy, fontSize: 11.5, fontWeight: '900', textAlign: 'center' }, actionBody: { color: palette.navy, fontSize: 9.5, lineHeight: 12, fontWeight: '500', textAlign: 'center' }, actionDivider: { width: 1, backgroundColor: '#E2E6EE', marginVertical: 7 },
