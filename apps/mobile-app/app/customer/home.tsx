...
const styles = StyleSheet.create({
  ...
  fleetCard: { minHeight: 162, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8E7F7', paddingHorizontal: 11, paddingTop: 11, paddingBottom: 10, overflow: 'hidden', shadowColor: '#122544', shadowOpacity: 0.06, shadowRadius: 10, elevation: 2 },
  fleetTop: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  fleetMainRow: { minHeight: 90, flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 4 },
  fleetCountBlock: { width: 78, minWidth: 78, alignItems: 'center', justifyContent: 'center', paddingLeft: 2 },
  fleetCount: { color: palette.navy, fontSize: 36, lineHeight: 40, fontWeight: '900' },
  ...
  scoreRing: { width: 66, height: 66, borderRadius: 33, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  scoreCore: { position: 'absolute', width: 47, height: 47, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E0EAF5', alignItems: 'center', justifyContent: 'center' },
  ...
  fleetImageHero: { flex: 1, height: 92, marginLeft: -8, marginRight: -5, opacity: 0.95 },
  ...
  fleetTicker: { minHeight: 31, marginTop: 5, paddingHorizontal: 1, flexDirection: 'row', alignItems: 'center', gap: 6 },
  ...
  quickDock: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8E7F7', paddingHorizontal: 10, paddingTop: 10, paddingBottom: 11, shadowColor: '#122544', shadowOpacity: 0.04, shadowRadius: 8, elevation: 2 },
  ...
  claimSummaryTop: { backgroundColor: palette.navy, paddingHorizontal: 12, paddingTop: 12, paddingBottom: 11 },
  ...
  claimMetric: { flex: 1, minHeight: 74, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6 },
