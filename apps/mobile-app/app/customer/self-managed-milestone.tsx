...
const styles = StyleSheet.create({
  ...
  saveButton: { marginTop: 16, minHeight: 50, borderRadius: 15, backgroundColor: '#0A43A3', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 }, saveText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' }, disabled: { opacity: 0.55 },
