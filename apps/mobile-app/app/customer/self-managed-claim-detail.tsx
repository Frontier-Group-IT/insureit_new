    ...
    <Screen title="Claim Tracker" showTitleHeader={false}>
      ...
      <View style={styles.heroCard}>
        ...
        <View style={styles.currentStageCard}>
          <View style={styles.currentStageIcon}><MaterialCommunityIcons name={next ? 'flag-outline' : 'check-decagram'} size={20} color="#0B63CE" /></View>
          <View style={styles.flexOne}>
...
const styles = StyleSheet.create({
  ...
  heroCard: { borderRadius: 18, borderWidth: 1, borderColor: '#CFE0FF', backgroundColor: '#F8FBFF', padding: 13, paddingLeft: 17, marginBottom: 10, overflow: 'hidden', shadowColor: palette.navy, shadowOpacity: 0.055, shadowRadius: 10, elevation: 2 },
  heroTop: { flexDirection: 'row', gap: 10, alignItems: 'center' },
  heroEyebrow: { color: '#0B63CE', fontSize: 10, fontWeight: '900', letterSpacing: 0.6 },
  heroValue: { color: palette.navy, fontSize: 19, fontWeight: '900', marginTop: 2 },
  heroMeta: { color: '#667085', fontSize: 10.5, fontWeight: '700', marginTop: 3 },
  progressRing: { width: 52, height: 52, borderRadius: 26, backgroundColor: '#EEF5FF', borderWidth: 3, borderColor: '#0B63CE', alignItems: 'center', justifyContent: 'center' },
  progressRingText: { color: '#0B63CE', fontSize: 11, fontWeight: '900' },
  progressTrack: { height: 8, borderRadius: 99, backgroundColor: '#E8EEF7', overflow: 'hidden', marginTop: 12 },
  progressFill: { height: '100%', backgroundColor: '#0B63CE' },
  currentStageCard: { flexDirection: 'row', gap: 10, alignItems: 'center', borderRadius: 14, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#CFE0FF', marginTop: 11, padding: 11 },
  currentStageIcon: { width: 40, height: 40, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: '#EEF5FF' },
  currentStageLabel: { color: '#0B63CE', fontSize: 9.5, fontWeight: '900', letterSpacing: 0.5 },
  currentStageTitle: { color: palette.navy, fontSize: 13.5, fontWeight: '900', marginTop: 2 },
  currentStageHint: { color: '#667085', fontSize: 11, lineHeight: 15, fontWeight: '700', marginTop: 3 },
  currentStageAction: { paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10, backgroundColor: palette.navy },
  currentStageActionText: { color: '#FFFFFF', fontSize: 9, fontWeight: '900' },
  infoCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE8F4', padding: 13, marginBottom: 10, shadowColor: palette.navy, shadowOpacity: 0.045, shadowRadius: 9, elevation: 1 },
  ...
  sectionCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE8F4', padding: 13, marginBottom: 10, shadowColor: palette.navy, shadowOpacity: 0.045, shadowRadius: 9, elevation: 1 },
  ...
  timelineCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE8F4', padding: 13, marginBottom: 10, shadowColor: palette.navy, shadowOpacity: 0.045, shadowRadius: 9, elevation: 1 },
  ...
  milestoneCard: { flex: 1, marginBottom: 9, padding: 11, borderRadius: 14, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E5ECF5' },
  milestoneCardActive: { backgroundColor: '#EEF5FF', borderColor: '#CFE0FF' },
  ...
  activityCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE8F4', padding: 13, marginBottom: 10, shadowColor: palette.navy, shadowOpacity: 0.045, shadowRadius: 9, elevation: 1 },
