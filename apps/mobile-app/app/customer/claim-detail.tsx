    ...
    <Screen title="Claim Detail" showLogout showTitleHeader={false}>
      ...
      <View style={[styles.heroCard, { borderColor: tone.border }]}>
        ...
        <View style={styles.heroTop}>
          <View style={[styles.statusIcon, { backgroundColor: tone.soft }]}><MaterialCommunityIcons name={settled ? 'check-decagram-outline' : 'shield-check-outline'} size={24} color={tone.accent} /></View>
        ...
        {selfManaged ? <View style={styles.heroProgressShell}>
      ...
      <View style={[styles.currentCard, { borderColor: tone.border, backgroundColor: tone.background }]}>
        ...
        <View style={styles.currentArrow}><MaterialCommunityIcons name={settled ? 'check' : 'arrow-top-right'} size={17} color={tone.accent} /></View>
      </View>
...
const styles = StyleSheet.create({
  ...
  heroCard:{position:'relative',borderWidth:1,borderRadius:21,padding:14,paddingLeft:18,backgroundColor:'#F4F8FF',overflow:'hidden',marginBottom:11,shadowColor:'#103763',shadowOpacity:.10,shadowRadius:14,shadowOffset:{width:0,height:6},elevation:2},heroOrbLarge:{position:'absolute',width:150,height:150,borderRadius:75,right:-56,top:-82,backgroundColor:'#DCEAFF',opacity:.78},heroOrbSmall:{position:'absolute',width:72,height:72,borderRadius:36,right:52,top:-36,backgroundColor:'#C4D9F4',opacity:.48},heroAccent:{position:'absolute',left:0,top:0,bottom:0,width:5},heroTop:{flexDirection:'row',alignItems:'center',gap:10},statusIcon:{width:47,height:47,borderRadius:15,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:'rgba(10,67,163,.12)'},heroCopy:{flex:1,minWidth:0},stageLabel:{fontSize:9,fontWeight:'900',letterSpacing:.6},vehicleNo:{color:palette.navy,fontSize:20,fontWeight:'900',marginTop:2},heroIdentity:{color:'#536B88',fontSize:10.5,fontWeight:'800',marginTop:2},focusStatusBadge:{maxWidth:100,borderWidth:1,borderRadius:999,paddingHorizontal:8,paddingVertical:5},focusStatusText:{fontSize:8.5,fontWeight:'900',textAlign:'center'},incidentRow:{marginTop:12,paddingTop:10,borderTopWidth:1,borderTopColor:'rgba(43,86,134,.13)',flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:10},metaLabel:{color:'#7890AC',fontSize:8.5,fontWeight:'900',letterSpacing:.6},incidentValue:{color:'#304866',fontSize:11,fontWeight:'900',marginTop:2},detailsToggle:{minHeight:40,borderRadius:11,paddingHorizontal:10,flexDirection:'row',alignItems:'center',gap:3,backgroundColor:'rgba(255,255,255,.78)',borderWidth:1,borderColor:'#D4E2F1'},detailsToggleText:{color:'#0A43A3',fontSize:9.5,fontWeight:'900'},heroProgressShell:{marginTop:11,borderRadius:13,backgroundColor:'rgba(255,255,255,.72)',borderWidth:1,borderColor:'#D7E4F2',padding:9},heroProgressTop:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},heroProgressLabel:{color:'#6C819C',fontSize:8,fontWeight:'900',letterSpacing:.7},heroProgressValue:{color:'#0A43A3',fontSize:10,fontWeight:'900'},heroProgressTrack:{height:7,borderRadius:999,backgroundColor:'#DCE5EF',marginTop:7,overflow:'hidden'},heroProgressFill:{height:'100%',borderRadius:999,backgroundColor:'#0A43A3'},infoBox:{marginTop:10,borderRadius:14,backgroundColor:'rgba(255,255,255,.78)',borderWidth:1,borderColor:'#D7E3F0',padding:10,gap:8},infoPair:{flexDirection:'row',gap:14},infoLabel:{color:'#7A8799',fontSize:8.5,fontWeight:'800'},infoValue:{color:'#30445E',fontSize:10.2,fontWeight:'900',marginTop:2},
  currentCard:{position:'relative',borderWidth:1,borderRadius:18,padding:12,paddingLeft:15,flexDirection:'row',alignItems:'center',gap:10,marginBottom:10,overflow:'hidden',shadowColor:'#153A64',shadowOpacity:.06,shadowRadius:8,shadowOffset:{width:0,height:3},elevation:1},currentAccent:{position:'absolute',left:0,top:0,bottom:0,width:4},currentIcon:{width:42,height:42,borderRadius:13,alignItems:'center',justifyContent:'center'},currentCopy:{flex:1,minWidth:0},currentEyebrow:{fontSize:8.5,fontWeight:'900',letterSpacing:.5},currentTitle:{color:palette.navy,fontSize:14.5,fontWeight:'900',marginTop:2},currentBody:{color:'#5F7086',fontSize:10.8,lineHeight:15,fontWeight:'700',marginTop:3},currentArrow:{width:31,height:31,borderRadius:10,backgroundColor:'rgba(255,255,255,.74)',alignItems:'center',justifyContent:'center'},secondaryActions:{flexDirection:'row',gap:8,marginBottom:10,flexWrap:'wrap'},
  sectionHeader:{minHeight:62,borderRadius:17,borderWidth:1,borderColor:'#D6E2EE',backgroundColor:'#F7FAFF',padding:11,marginTop:10,flexDirection:'row',alignItems:'center',gap:10,shadowColor:'#153A64',shadowOpacity:.045,shadowRadius:6,shadowOffset:{width:0,height:2},elevation:1},sectionHeaderIcon:{width:38,height:38,borderRadius:12,backgroundColor:'#E7F0FC',borderWidth:1,borderColor:'#D4E2F2',alignItems:'center',justifyContent:'center'},sectionHeaderCopy:{flex:1,minWidth:0},sectionTitle:{color:palette.navy,fontSize:14,fontWeight:'900'},sectionSub:{color:'#718198',fontSize:10,fontWeight:'700',marginTop:2},sectionBody:{borderWidth:1,borderTopWidth:0,borderColor:'#D6E2EE',backgroundColor:'#FFFFFF',borderBottomLeftRadius:17,borderBottomRightRadius:17,padding:10,gap:8},journeyBody:{padding:8,gap:0},
  stageRow:{minHeight:72,paddingHorizontal:8,paddingVertical:9,flexDirection:'row',alignItems:'stretch',gap:9,borderBottomWidth:1,borderBottomColor:'#EEF2F6'},stageRowCurrent:{backgroundColor:'#EDF5FF',borderRadius:14,borderWidth:1,borderColor:'#C8DCF3',marginVertical:4,paddingHorizontal:10,shadowColor:'#0A43A3',shadowOpacity:.06,shadowRadius:6,shadowOffset:{width:0,height:2},elevation:1},stageRail:{width:30,alignItems:'center'},stageNode:{width:30,height:30,borderRadius:15,backgroundColor:'#EEF2F6',borderWidth:1,borderColor:'#E0E6ED',alignItems:'center',justifyContent:'center'},stageDone:{backgroundColor:'#168161',borderColor:'#168161'},stageCurrent:{backgroundColor:'#0A43A3',borderColor:'#0A43A3'},stageLine:{width:2,flex:1,minHeight:20,marginTop:4,backgroundColor:'#E4EAF1'},stageLineDone:{backgroundColor:'#A9D8C7'},stageCopy:{flex:1,minWidth:0,justifyContent:'center'},stageTitle:{color:palette.navy,fontSize:11.5,fontWeight:'900'},stageMeta:{color:'#7A8799',fontSize:9.5,fontWeight:'700',marginTop:2},stageMetaCurrent:{color:'#0A43A3',fontWeight:'900'},stageEventLabel:{color:'#8B9AAD',fontSize:8.5,fontWeight:'700',marginTop:3},stageRight:{width:112,alignItems:'flex-end',justifyContent:'center',gap:3},stageDate:{color:'#344054',fontSize:9.5,lineHeight:13,fontWeight:'800',textAlign:'right'},stageDateMuted:{color:'#98A2B3'},stageAmount:{color:'#10365F',fontSize:10.8,fontWeight:'900',backgroundColor:'#EEF4FB',paddingHorizontal:7,paddingVertical:3,borderRadius:999},
