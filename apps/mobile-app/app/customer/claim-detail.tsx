...
const styles = StyleSheet.create({
  ...
  claimNumberCard:{width:'100%',maxWidth:342,borderRadius:22,backgroundColor:'#FFFFFF',paddingHorizontal:18,paddingTop:18,paddingBottom:15,alignItems:'center',shadowColor:'#071D49',shadowOpacity:.2,shadowRadius:20,shadowOffset:{width:0,height:10},elevation:12},
