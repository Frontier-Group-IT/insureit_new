  ...
  return (
    <Screen title="Claim Detail" showLogout showTitleHeader={false}>
      ...
      >
        ...
        <View style={[styles.currentIcon, { backgroundColor: tone.soft }]}><MaterialCommunityIcons name="flag-checkered" size={21} color={tone.accent} /></View>
...
const styles = StyleSheet.create({
  ...
  stageRow:{minHeight:46,paddingHorizontal:4,paddingVertical:2,flexDirection:'row',alignItems:'stretch',gap:5,borderBottomWidth:1,borderBottomColor:'#EEF2F6'},stageRowCurrent:{backgroundColor:'#EDF5FF',borderRadius:8,borderWidth:1,borderColor:'#C8DCF3',marginVertical:1,paddingHorizontal:5},stageRail:{width:19,alignItems:'center',paddingTop:7},stageNode:{width:18,height:18,borderRadius:9,backgroundColor:'#EEF2F6',borderWidth:1,borderColor:'#E0E6ED',alignItems:'center',justifyContent:'center'},stageDone:{backgroundColor:'#168161',borderColor:'#168161'},stageCurrent:{backgroundColor:'#0A43A3',borderColor:'#0A43A3'},stageLine:{width:1,flex:1,minHeight:6,marginTop:2,backgroundColor:'#E4EAF1'},stageLineDone:{backgroundColor:'#A9D8C7'},stageCopy:{flex:1,minWidth:0,justifyContent:'center'},stageTitle:{color:palette.navy,fontSize:9.6,lineHeight:11.2,fontWeight:'900'},stageMeta:{color:'#7A8799',fontSize:8,lineHeight:9.4,fontWeight:'700',marginTop:1},stageMetaCurrent:{color:'#0A43A3',fontWeight:'900'},stageRight:{width:84,alignItems:'flex-end',justifyContent:'center',gap:1},stageDate:{color:'#344054',fontSize:7.7,lineHeight:9.2,fontWeight:'800',textAlign:'right'},stageDateMuted:{color:'#98A2B3'},stageAmount:{color:'#10365F',fontSize:8,lineHeight:9.5,fontWeight:'900',backgroundColor:'#EEF4FB',paddingHorizontal:5,paddingVertical:1,borderRadius:999},
