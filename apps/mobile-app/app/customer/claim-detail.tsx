...
const styles = StyleSheet.create({
  ...
  journeyHeader:{minHeight:40,borderRadius:12,paddingVertical:5,paddingHorizontal:7,marginTop:6,gap:6},journeyHeaderIcon:{width:28,height:28,borderRadius:8},journeyHeaderTitle:{fontSize:12,lineHeight:14},journeyHeaderSub:{fontSize:9.2,lineHeight:11,marginTop:1},journeyBody:{paddingVertical:5,paddingHorizontal:5,gap:4},
