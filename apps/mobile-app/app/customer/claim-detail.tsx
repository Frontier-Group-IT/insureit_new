    ...
    <Screen title="Claim Detail" showLogout showTitleHeader={false}>
      <View style={styles.pageHeading}>
        ...
        {selfManaged ? <View style={styles.headingActions}>
          ...
          >
            <Image source={require('../../assets/get-assistance-icon.png')} style={styles.assistanceIconImage} resizeMode="contain" />
          </Pressable>
        </View> : null}
      </View>
...
const styles = StyleSheet.create({
  pageHeading:{marginBottom:8,flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:10},pageHeadingCopy:{flex:1,minWidth:0},pageEyebrow:{color:'#145ED7',fontSize:10,fontWeight:'900',letterSpacing:1},pageTitle:{color:palette.navy,fontSize:24,fontWeight:'900',marginTop:2},pageSubtitle:{color:'#6A7789',fontSize:10.5,lineHeight:15,fontWeight:'600',marginTop:3},headingActions:{flexDirection:'row',alignItems:'center',gap:7,flexShrink:0},assistanceIconButton:{width:38,height:38,borderRadius:12,alignItems:'center',justifyContent:'center',backgroundColor:'#F4F8FE',borderWidth:1,borderColor:'#D7E5F7',overflow:'hidden'},assistanceIconButtonPressed:{backgroundColor:'#E8F1FD',transform:[{scale:.97}]},assistanceIconImage:{width:28,height:28},
