...
export default function ClaimDetailScreen() {
  ...
  return <Screen title="Claim Detail" showLogout showTitleHeader={false}>
    <View style={styles.pageHeading}><Text style={styles.pageEyebrow}>CLAIMS</Text><Text style={styles.pageTitle}>Claim Detail</Text></View>
