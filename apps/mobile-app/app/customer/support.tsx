...
const styles = StyleSheet.create({
  pageHeading: { marginTop: 0, marginBottom: 10 }, pageTitle: { color: palette.ink, fontSize: 25, fontWeight: '900' }, pageSub: { color: palette.slate, fontSize: 12, fontWeight: '700', marginTop: 2 },
