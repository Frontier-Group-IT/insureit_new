...
const styles = StyleSheet.create({
  ...
  footer: { paddingHorizontal: 15, paddingTop: 10, paddingBottom: 11, backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#DFE6EF', gap: 10 }, submitButton: { minHeight: 53, borderRadius: 12, backgroundColor: '#0A3B8F', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 }, submitDisabled: { opacity: 0.7 }, submitText: { color: '#FFFFFF', fontSize: 15, fontWeight: '700' },
