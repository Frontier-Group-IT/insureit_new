...
export function GroupRecordsScreen({ mode }: { mode: Mode }) {
  ...
  return <Screen title={title} showLogout>
    <View style={styles.hero}><View><Text style={styles.heroTitle}>{title}</Text><Text style={styles.heroSub}>{summary}</Text></View><View style={styles.heroIcon}><MaterialCommunityIcons name={mode === 'fleet' ? 'truck-outline' : mode === 'policies' ? 'file-document-outline' : 'shield-search-outline'} size={27} color="#FFFFFF" /></View></View>
...
const styles = StyleSheet.create({
  hero: { minHeight: 96, borderRadius: 18, backgroundColor: palette.navy, padding: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 11 }, heroTitle: { color: '#FFFFFF', fontSize: 21, fontWeight: '900' }, heroSub: { color: '#D7E6FF', fontSize: 10.5, fontWeight: '600', marginTop: 4 }, heroIcon: { width: 48, height: 48, borderRadius: 15, backgroundColor: 'rgba(255,255,255,0.12)', alignItems: 'center', justifyContent: 'center' }, searchBox: { minHeight: 48, borderRadius: 14, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE6F0', paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 9 }, searchInput: { flex: 1, minHeight: 44, color: palette.navy, fontSize: 13, fontWeight: '600' }, accountFilters: { gap: 7, paddingBottom: 12 }, filterChip: { maxWidth: 180, height: 34, borderRadius: 999, borderWidth: 1, borderColor: '#D8E3EF', backgroundColor: '#FFFFFF', paddingHorizontal: 12, justifyContent: 'center' }, filterChipActive: { backgroundColor: palette.navy, borderColor: palette.navy }, filterText: { color: '#65758B', fontSize: 10.5, fontWeight: '800' }, filterTextActive: { color: '#FFFFFF' }, recordCard: { minHeight: 105, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE8F4', padding: 12, paddingLeft: 16, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 10, overflow: 'hidden', shadowColor: '#122544', shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 }, accent: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 5 }, recordIcon: { width: 45, height: 45, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, recordCopy: { flex: 1, minWidth: 0 }, accountName: { color: '#0A43A3', fontSize: 9.5, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 0.3 }, recordTitle: { color: palette.navy, fontSize: 15.5, fontWeight: '900', marginTop: 2 }, recordSubtitle: { color: '#334155', fontSize: 10.5, fontWeight: '700', marginTop: 2 }, recordMeta: { color: '#65758B', fontSize: 9.8, lineHeight: 13, fontWeight: '600', marginTop: 2 }, statusPill: { maxWidth: 88, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 5 }, statusText: { fontSize: 8.8, lineHeight: 11, fontWeight: '900', textAlign: 'center' },
});