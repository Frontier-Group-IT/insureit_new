...
const styles = StyleSheet.create({
  ...
  bottomNav: { backgroundColor: 'rgba(255,255,255,0.98)', borderRadius: 20, paddingVertical: 8, paddingHorizontal: 5, flexDirection: 'row', justifyContent: 'space-between', borderWidth: 1, borderColor: palette.line, shadowColor: palette.ink, shadowOpacity: 0.1, shadowRadius: 12, elevation: 4 },
  bottomItem: { flex: 1, alignItems: 'center', gap: 4, minHeight: 58, justifyContent: 'center' },
  bottomIconShell: { width: 40, height: 34, borderRadius: 13, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'transparent', backgroundColor: 'transparent' },
