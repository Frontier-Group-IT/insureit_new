...
const resolvePackage = (name) => path.dirname(require.resolve(`${name}/package.json`, { paths: [projectRoot] }));
...
module.exports = withUniwindConfig(config, { cssEntryFile: './global.css', dtsFile: './uniwind-types.d.ts' });
function escapePath(value) { return value.replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"); }
