...
const cases: Case[] = [
  {
    ...
    tables: [{ page: 2, rows: [
      ...
      ["Total IDV", "472269"], ["Gross OD (A)", "2930"], ["Basic TP Premium", "16049"], ["Gross TP (B)", "16424"],
  ...
  },
  {
    ...
    tables: [{ page: 1, rows: [
      ...
      ["Gross OD (A)", "4753"], ["Basic TP Premium", "16049"], ["Gross TP (B)", "16524"], ["Premium (A + B)", "21277"], ["Total GST", "1743.49"], ["Total Payable Premium", "23020.49"],
    ] }],
