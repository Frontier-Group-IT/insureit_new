...
const SYNTHETIC_ENGINE = "ENGTEST90012345";
const SYNTHETIC_CHASSIS = "TESTVIN12ABC34567";
...
draw(`${SYNTHETIC_ENGINE}/TESTVIN12`, 560, 450);
draw("ABC34567", 560, 435);
...
assert.equal(field("vehicle_chassis_number"), SYNTHETIC_CHASSIS);
assert.equal(field("vehicle_engine_number"), SYNTHETIC_ENGINE);
...
assert.equal(noEvidence, parsed, "input without native text must remain unchanged");
