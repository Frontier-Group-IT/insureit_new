...
export function VehicleClassCapacityFields({ defaultClass = "", defaultCapacity = "" }: { defaultClass?: string | null; defaultCapacity?: string | null }) {
  ...
  return <>
    <div className="min-w-0">
      <label className={labelClass} htmlFor="vehicle_type">
        Class *{vehicleMeta ? <span className="ml-1 text-[9px] font-medium text-[#315B6B]">{vehicleMeta.description}</span> : null}
      </label>
