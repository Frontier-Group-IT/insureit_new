...
function HeaderIcon({ src, alt }: { src: string; alt: string }) { return <Image src={src} alt={alt} width={30} height={30} className="h-[30px] w-[30px] object-contain" />; }
