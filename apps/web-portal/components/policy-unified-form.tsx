...
export function PolicyUnifiedForm({ mode, insurers, customers = [], rms, sources, manufacturers = [], initialValues, nonMotorInitialValues, commercialAccess = true, preselectedCustomerId = null, sourceIntakeId = null, initialDraftRevision = null, initialRegistrationMode = "registered" }: Props) {
  ...
  function useExistingVehicleFromConflict(){
  ...
  function resolveBusinessConflict(action:"view_existing"|"edit_existing_policy"|"use_existing_vehicle"|"edit_vehicle"|"edit_manufacturer"|"edit_policy_number"|"edit_dates"|"use_suggested_start"|"continue_gap"|"continue_active"|"continue_expired"|"replace_existing"){
    ...
    if(action==="use_existing_vehicle"){useExistingVehicleFromConflict();return;}
  ...
  const ocrImportContext:PolicyOcrImportContext={
    ...
    protectedKeys:appliedRc||selectedExistingVehicleId?[...SECTION_02_OCR_FIELDS]:[],
  };
