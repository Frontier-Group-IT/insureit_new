  ...
  return (
    <div className="flex flex-wrap items-center justify-end gap-2">
      <label className="inline-flex h-[34px] min-w-[118px] items-center gap-2 rounded-[5px] border border-[#ced9e6] bg-white px-2.5 text-[#23456d] shadow-[0_1px_2px_rgba(16,41,92,0.03)] transition hover:border-[#91a9c3] hover:bg-[#f8fbff]">
        ...
        <select name="horizon" value={String(horizonDays)} className="report-header-select min-w-0 flex-1 cursor-pointer border-0 bg-transparent pr-1 text-[10px] font-bold text-inherit outline-none" onChange={(event)=>update("horizon",event.target.value)}>
      ...
      <label className="inline-flex h-[34px] min-w-[165px] items-center gap-2 rounded-[5px] border border-[#ced9e6] bg-white px-2.5 text-[#23456d] shadow-[0_1px_2px_rgba(16,41,92,0.03)] transition hover:border-[#91a9c3] hover:bg-[#f8fbff]">
        ...
        <select name="exception" value={exception??""} className="report-header-select min-w-0 flex-1 cursor-pointer border-0 bg-transparent pr-1 text-[10px] font-bold text-inherit outline-none" onChange={(event)=>update("exception",event.target.value)}>
