...
export function MobileBottomNavigation({role: _role,permissionAccess}:{role:string|null|undefined;permissionAccess:Partial<Record<Capability,PermissionAccess>>}) {
