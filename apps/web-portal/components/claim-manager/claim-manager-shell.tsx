  ...
  return (
    <div className="min-h-screen text-[#10213D]">
      ...
      <div className="lg:pl-[268px]">
        <header className="sticky top-0 z-40 border-b border-white/70 bg-white/82 backdrop-blur-2xl supports-[backdrop-filter]:bg-white/72">
          <div className="flex min-h-[66px] items-center justify-between gap-2 px-2.5 py-2 sm:px-4 lg:px-6">
            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <h1 className="truncate font-[var(--font-display)] text-[17px] font-semibold tracking-[-0.035em] text-[#12203B] sm:text-[18px]">{title}</h1>
              </div>
            </div>
            ...
            <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
              ...
              <Link href="/customers/posp-misp" className="hidden h-10 items-center gap-2 rounded-xl bg-gradient-to-r from-[#6759ff] to-[#17bfc5] px-3.5 text-[11px] font-bold text-white shadow-[0_10px_24px_rgba(103,89,255,.24)] hover:-translate-y-0.5 md:inline-flex">
              ...
              <div className="border-l border-[#dde3ec] pl-1.5 sm:pl-2">
