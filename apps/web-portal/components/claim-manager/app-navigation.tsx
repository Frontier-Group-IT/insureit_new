...
import { BarChart3, CheckSquare2, ChevronRight, ClipboardList, FileCheck2, FlaskConical, Gauge, Landmark, LayoutGrid, Plus, Scale, Settings, ShieldCheck, Sparkles, Upload, UserCog, UserPlus, UsersRound } from "lucide-react";
...
type SectionKey="claims"|"distribution"|"master-data"|"customers"|"fleet"|"tasks"|"accounts"|"reports"|"development";
...
type Props={activeNav:ActiveNav;role:string|null|undefined;permissionAccess:PermissionAccessMap;accountsAccess?:boolean};
...
export const navigationSections:NavigationSection[]=[
 ...
 {key:"accounts",label:"Accounts",icon:Landmark,tint:"from-[#0f766e] to-[#0ea5a4]",capability:"view_accounts",items:[
  {href:"/accounts",label:"Accounts Dashboard",icon:Landmark,capability:"view_accounts"},
  {href:"/policies/commercial-review",label:"Commercial Control",icon:Scale,capability:"view_accounts"},
  {href:"/reconciliation",label:"Insurer Reconciliation",icon:ClipboardList,capability:"view_accounts"},
  {href:"/reconciliation/history",label:"Reconciliation History",icon:FileCheck2,capability:"view_accounts"}
 ]},
...
const developmentSection:NavigationSection={key:"development",label:"Development",icon:FlaskConical,tint:"from-[#7C3AED] to-[#2563EB]",capability:"manage_system",items:[
 ...
 {href:"/system/policy-ocr-training",label:"OCR Benchmark",icon:FlaskConical,capability:"manage_system"},
