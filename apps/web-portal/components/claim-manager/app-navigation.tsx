...
const sections:Array<{key:SectionKey;label:string;icon:LucideIcon;tint:string;items:Item[]}>= [
 ...
 {key:"distribution",label:"Intermediatory",icon:Sparkles,tint:"from-[#17c7c9] to-[#6759ff]",items:[{href:"/intermediaries",label:"Overview",icon:UsersRound},{href:"/intermediaries/posp",label:"POSP",icon:UsersRound},{href:"/intermediaries/misp",label:"MISP",icon:UsersRound},{href:"/intermediaries/partner",label:"Business Associates",icon:UsersRound},{href:"/customers/posp-misp",label:"Onboarding Applications",icon:FileCheck2}]},
