...
export const navigationSections:Array<{key:SectionKey;label:string;icon:LucideIcon;tint:string;items:Item[]}>= [
 ...
 {key:"distribution",label:"Intermediatory",icon:Sparkles,tint:"from-[#17c7c9] to-[#6759ff]",items:[{href:"/intermediaries",label:"Overview",icon:UsersRound},{href:"/intermediaries/posp",label:"POSP",icon:UsersRound},{href:"/intermediaries/misp",label:"MISP",icon:UsersRound},{href:"/intermediaries/partner",label:"Partners",icon:UsersRound},{href:"/customers/posp-misp",label:"Onboarding Applications",icon:FileCheck2}]},
 {key:"master-data",label:"Master Data",icon:LayoutGrid,tint:"from-[#6759ff] to-[#8f7cff]",items:[{href:"/employees",label:"Employees",icon:UsersRound},{href:"/customers",label:"Customers",icon:UsersRound},{href:"/customer-kyc",label:"Customer KYC",icon:FileCheck2},{href:"/vehicles",label:"Vehicles",icon:Gauge},{href:"/policies",label:"Policies",icon:ShieldCheck}]},
...
export function sectionForPath(pathname:string):SectionKey|null{
 ...
 if(pathname==="/employees"||pathname.startsWith("/employees/")||pathname==="/customers"||pathname==="/customer-kyc"||pathname.startsWith("/customer-kyc/")||pathname==="/vehicles"||pathname.startsWith("/vehicles/")||pathname==="/policies"||pathname.startsWith("/policies/"))return"master-data";
 return null;
}
