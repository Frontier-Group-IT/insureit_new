...
export function PartnerPageHeader({
  ...
  return (
    <div className="flex flex-col gap-3 border-b border-[#DCE4ED] pb-4 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div className={"grid border-y border-[#DCE4ED] sm:grid-cols-2 " + grid}>
      {items.map((item, index) => (
        ...
        >
          ...
          <div className="mt-1.5 truncate text-[20px] font-extrabold tracking-[-0.025em] text-[#162746]">{item.value}</div>
