            ...
            <div className="divide-y divide-[#E8EDF4]">
              {section.rows.map((row) => (
                <div key={row.partner_id} className="py-5">
                  ...
                  <div className="mt-5 rounded-xl border border-[#E4EAF2] bg-white p-3.5 shadow-[0_5px_18px_rgba(49,86,184,0.035)]">
                    ...
                    {row.children.length ? (
                      <div className="mt-3 grid gap-2 rounded-lg border border-[#DFEAF8] bg-[#F5F9FF] p-3 md:grid-cols-2 xl:grid-cols-3">
                        {row.children.map((child) => (
                          <div key={child.intermediary_id} className="flex items-center gap-3 rounded-lg bg-white/70 px-3 py-3">
                      ...
                      <div className="mt-3 flex min-h-[78px] flex-col items-center justify-center rounded-lg border border-[#DFEAF8] bg-[#F5F9FF] px-4 py-4 text-center">
