...
import { BarChart3, Building2, ChevronDown, FileText, Network, RefreshCcw, Search, ShieldCheck, UserRound, UsersRound } from "lucide-react";
      ...
      <div className="p-3">
        {sections.length ? <div className="space-y-2">{sections.map((section) => {
          ...
          return <div key={section.key} className="overflow-hidden rounded-lg border border-[#E1E8F2] bg-white">
            {!hideUngroupedHeader ? <div className="flex items-center justify-between gap-3 bg-[#F5F9FF] px-3.5 py-2.5">
              <div className="flex min-w-0 items-center gap-3">
