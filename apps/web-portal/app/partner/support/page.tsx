            ...
            <>
              <div className="flex flex-col gap-4 border-b border-[#DCE4ED] py-5 sm:flex-row sm:items-center">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h3 className="mt-1 break-words text-[17px] font-extrabold leading-6 text-[#172846] sm:text-[18px]">{contact.name}</h3>
...
function ContactAction({
  ...
  return href ? (
    <a href={href} className="flex min-h-[68px] items-center gap-3 border-b border-[#E6ECF3] px-1 py-3.5 transition hover:bg-[#F8FAFD] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#3156B8]/20 sm:border-r sm:px-4 last:sm:border-r-0">
      {body}
    </a>
  ) : (
    <div className="flex min-h-[68px] items-center gap-3 border-b border-[#E6ECF3] px-1 py-3.5 sm:border-r sm:px-4 last:sm:border-r-0">
      {body}
    </div>
  );
}
...
function OpsCard({
  ...
  return (
    <Link href={href} className={"group flex min-h-[76px] items-center gap-3 border-b px-1 py-3.5 transition hover:bg-white/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#3156B8]/20 lg:border-b-0 lg:border-r lg:px-4 lg:last:border-r-0 " + (emphasis ? "border-[#F0D7AE] bg-[#FFF8EC]" : "border-[#E0E7EF]")}>
      <span className={"grid h-10 w-10 shrink-0 place-items-center rounded-xl " + (emphasis ? "bg-[#FFF1D9] text-[#A86809]" : "bg-white text-[#3156B8]")}><Icon className="h-4 w-4" /></span>
      <span className="min-w-0 flex-1">
