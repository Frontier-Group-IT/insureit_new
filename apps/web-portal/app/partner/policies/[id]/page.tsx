  ...
  return (
    <PartnerPortalShell title="Policy Detail">
      <div className="space-y-7">
        <Link href="/partner/policies" className="inline-flex min-h-9 items-center gap-2 rounded-lg border border-[#D2DCE9] bg-white px-3 text-[10px] font-bold text-[#203653] transition hover:bg-[#F8FAFD] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3156B8]/20">
        ...
        <section className="overflow-hidden border-y border-[#DCE4ED] bg-white/45">
          <div className="flex flex-col gap-4 border-b border-[#E6ECF3] px-1 py-4 sm:px-4 sm:py-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex min-w-0 items-start gap-4">
              <span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-[#EEF4FF] text-[#3156B8]"><ShieldCheck className="h-5 w-5" /></span>
...
function HeroMetric({ label, value }: { label: string; value: string }) {
  return <div className="border-b border-[#E6ECF3] px-1 py-3.5 sm:border-r sm:px-4 sm:py-4 xl:border-b-0 xl:last:border-r-0"><p className="text-[8.5px] font-black uppercase tracking-[0.1em] text-[#7A899F]">{label}</p><p className="mt-1.5 break-words text-[10.5px] font-extrabold leading-4 text-[#203653] sm:text-[11px]">{value}</p></div>;
}
