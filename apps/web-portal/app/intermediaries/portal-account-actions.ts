...
function safeReturnPath(value: string | null) { return value && /^\/intermediaries(?:\/portal-users|\/(?:posp|misp|partner)|\/applications\/[0-9a-f-]+)?$/i.test(value) ? value : "/intermediaries"; }
