  ...
  return <section className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm">
    <div className="flex flex-wrap items-start justify-between gap-3">
      <div>
        ...
        <h3 className="mt-1 text-[12px] font-semibold text-[#0F172A]">iCall {accountLabel} Training - UAT</h3>
        <p className="mt-1 max-w-2xl text-[9.5px] leading-5 text-[#526178]">Register this {accountLabel} in the iCall test environment and sync training and examination status directly into InsureIt.</p>
      </div>
