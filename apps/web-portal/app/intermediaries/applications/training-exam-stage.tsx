...
export function TrainingExamStage({ applicationId, profile, assignment, documents, iibVerified, finalType }: Props) {
  ...
  return <div id="qualification-process" className="space-y-4 scroll-mt-24">
    ...
    {examPassed ? <ProcessSection id="agreement-requirement" number="4" title="Agreement" subtitle="Send and record signing." state={agreementSigned ? "completed" : "current"} statusText={agreementSigned ? "Agreement signed" : "Action required"}>
