...
function safeReturnPath(path: string | null) { return path && /^\/intermediaries(?:\/portal-users(?:\/[0-9a-f-]+)?|\/(?:posp|misp|partner)|\/applications\/[0-9a-f-]+)?$/i.test(path) ? path : "/intermediaries"; }
