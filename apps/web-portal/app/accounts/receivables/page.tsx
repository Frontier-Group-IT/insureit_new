...
export default async function ReceivablesPage() {
  ...
  return <AppShell title="Insurer Receivables"><div className="mx-auto max-w-[1650px] space-y-4 pb-10">
    <section className="rounded-2xl border border-[#dbe3ee] bg-white p-5 shadow-sm"><div className="flex flex-wrap items-center justify-between gap-4"><div className="flex items-center gap-2 text-[#17365D]"><Landmark className="h-5 w-5 shrink-0 text-[#0f766e]"/><h1 className="text-[21px] font-semibold">Insurer Receivable Ledger</h1></div><Link href="/accounts/billing" className="inline-flex items-center gap-2 rounded-xl border border-[#d8e1ec] px-4 py-2 text-[9px] font-bold text-[#17365D]">Brokerage billing <ReceiptText className="h-3.5 w-3.5"/></Link></div></section>
