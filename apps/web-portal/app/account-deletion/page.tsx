    ...
    <main className="min-h-screen bg-[#F4F9FF] px-5 py-10 text-[#17202F]">
      <div className="mx-auto max-w-2xl rounded-[28px] border border-[#D7E6F5] bg-white p-6 shadow-[0_24px_70px_rgba(11,55,105,0.12)] sm:p-8">
        ...
        <p className="mt-3 text-sm font-medium leading-6 text-[#59687A]">
          ...
          InsureIT mobile app or by using the request option below.
        </p>
        ...
        <section className="mt-7 rounded-2xl border border-[#DCE8F4] bg-[#F8FBFF] p-5">
          ...
          <ol className="mt-3 space-y-3 text-sm leading-6 text-[#46566B]">
            ...
            <li><strong>Outside the app:</strong> send a deletion request using the email button below from your registered email address where possible.</li>
          </ol>
        </section>
        ...
        <p className="mt-4 text-xs leading-5 text-[#6A788C]">
          Include your registered mobile number or email address so we can verify the account. Do not email copies of
          Aadhaar, PAN, policy documents, claim documents, or other sensitive files unless our team specifically asks
        ...
        <div className="mt-7 border-t border-[#E4ECF5] pt-5 text-sm">
          ...
          <a href="mailto:insureit@frontiergroup.in" className="font-bold text-[#0B63CE]">Privacy contact</a>
        </div>
      </div>
    </main>
  );
