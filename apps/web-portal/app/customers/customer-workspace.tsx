...
const partnerOptions = [
  ...
  { value: "posp", label: "POSP", description: "Point of Sales Person application and training details", available: true },
  { value: "misp", label: "MISP", description: "Motor insurance service provider application and DP contact", available: true }
];
      ...
      <section className="mx-auto max-w-[1440px] overflow-hidden rounded-xl border border-[#E2E8F0] bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
        <div className="flex flex-col gap-2 border-b border-[#E2E8F0] px-3 py-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row">
            ...
            <Link href="/customers/posp-misp" className="inline-flex h-9 items-center justify-center rounded-md border border-[#CBD5E1] bg-white px-3 text-[10.5px] font-semibold text-[#334155]">POSP / MISP</Link>
