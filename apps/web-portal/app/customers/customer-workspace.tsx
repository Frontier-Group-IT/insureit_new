  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-[1440px] overflow-hidden rounded-[22px] border border-[#E2E8F0] bg-white/94 shadow-[0_18px_55px_rgba(39,51,89,.08)]">
        <div className="border-b border-[#E2E8F0] p-2.5 sm:p-3">
