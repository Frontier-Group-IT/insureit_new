...
export default async function ApplicationReviewPage({ params, searchParams }: PageProps) {
  ...
  const supportedPartner = ["individual_proprietor","group","corporate","dealership"].includes(application.partner_type??"");
