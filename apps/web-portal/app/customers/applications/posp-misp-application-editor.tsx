...
function Header({ number, title, subtitle }: { number: string; title: string; subtitle: string }) { return <div className="flex items-start gap-3 border-b border-[#E2E8F0] !bg-white px-4 py-3 !text-[#0F172A]"><span className="grid h-7 w-7 place-items-center rounded-lg bg-[#EEF2F7] text-[9px] font-bold text-[#071D49]">{number}</span><div><h3 className="text-[12.5px] font-semibold text-[#0F172A]">{title}</h3><p className="mt-0.5 text-[9.8px] text-[#64748B]">{subtitle}</p></div></div>; }
