...
type Props = { customer: Customer; documents: DocumentRow[]; vehicles: VehicleRow[]; agents: AgentOption[]; action: (formData: FormData) => void | Promise<void>; errorMessage?: string | null; errorField?: string | null };
...
export function CustomerProfileEditor({ customer, documents, agents, action, errorMessage, errorField }: Props) {
