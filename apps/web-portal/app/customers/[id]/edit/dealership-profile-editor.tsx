...
export function DealershipProfileEditor({ action, values, contacts, documents, oems }: Props) {
  ...
  return <>
    {state.error && showError ? <AlertModal open title="Unable to save dealership" message={state.error} onClose={() => setShowError(false)} /> : null}
