    ...
    <div className="overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white shadow-sm">
      <div className="flex flex-col gap-3 border-b border-[#E2E8F0] bg-[#F8FAFC] px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          <div className="shrink-0"><h2 className="text-[12px] font-semibold text-[#0F172A]">Pending Applications</h2><p className="mt-0.5 text-[9.5px] text-[#64748B]">Primary details completed; required documents are still pending.</p></div>
