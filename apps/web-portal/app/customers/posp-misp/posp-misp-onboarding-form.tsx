              ...
              <div className="grid min-w-0 gap-3 md:col-span-2 md:grid-cols-2 xl:col-span-4 xl:grid-cols-5">
                ...
                <div className="md:col-span-2 xl:col-span-3">
                  ...
                  <div className="grid min-w-0 gap-2 md:grid-cols-3">
                    ...
                    <Field label="Last Name" name="pos_last_name" hideLabel placeholder="Last name" defaultValue={initialValues.pos_last_name} {...inputValidationHandlers} />
                  </div>
                </div>
              </div>
              <div className="grid min-w-0 gap-3 md:col-span-2 md:grid-cols-2 xl:col-span-4 xl:grid-cols-5">
...
function requiredFields(partnerType: PartnerType) {
  ...
  return new Set(partnerType === "misp"
    ? [...common, "misp_name", "oem_name", "dp_first_name", "dp_phone", "dp_email", "dp_pan_number", "gst_number"]
    : [...common, "pos_first_name", "applicant_phone", "applicant_email"]);
}
