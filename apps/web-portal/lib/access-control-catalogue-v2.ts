...
export const permissionCatalogueV2 = [
  ...
  { key: "policy_intakes.view", module: "Policies", label: "View policy intakes", description: "View Policy Intake requests inside the permitted sales or Operations scope.", risk: "standard", allowedAccess: ["view"], allowedScopes: recordScopes, scopeRequired: true },
  { key: "policy_intakes.create", module: "Policies", label: "Initiate policy onboarding", description: "Submit a policy copy against an assigned Partner, POSP or MISP for OCR-assisted Operations review.", risk: "sensitive", allowedAccess: ["edit"], allowedScopes: hierarchyScopes, scopeRequired: true },
  { key: "policy_intakes.review", module: "Policies", label: "Review policy intakes", description: "Review intake OCR results and hand them into governed Policy Onboarding.", risk: "high", allowedAccess: ["edit"], allowedScopes: recordScopes, scopeRequired: true },
...
export const legacyCapabilityCompatibilityMap: Record<LegacyCapability, readonly PermissionKeyV2[]> = {
  ...
  view_policy_intakes: ["policy_intakes.view"],
  create_policy_intakes: ["policy_intakes.create"],
  review_policy_intakes: ["policy_intakes.review"],
