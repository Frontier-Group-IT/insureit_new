...
const labels: Record<Capability, Omit<PermissionDefinition, "capability" | "roleAccess">> = {
  ...
  review_policy_ocr_training: { module: "Policies", label: "Review premium OCR training", description: "Correct OCR proposals and submit verified Section 03 training labels.", risk: "high" },
  approve_policy_ocr_training: { module: "Policies", label: "Approve premium OCR training", description: "Give separate owner approval for reviewed and sanitized OCR training candidates.", risk: "critical" },
