...
const labels: Record<Capability, Omit<PermissionDefinition, "capability" | "roleAccess">> = {
  ...
  create_customers: { module: "Customers", label: "Add customers", description: "Create new customer onboarding records without granting authority to edit existing customer identity or KYC records.", risk: "sensitive" },
