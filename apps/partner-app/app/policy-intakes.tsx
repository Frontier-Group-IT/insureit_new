      ...
      <View style={styles.hero}>
        <View style={styles.heroTop}>
          <View style={styles.heroBody}>
            ...
            <Text style={styles.heroText}>Upload once and track extraction, Operations review and final policy creation from the same intake.</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { marginTop: 5, color: '#FFFFFF', fontSize: 19, lineHeight: 25, fontWeight: '900' },
  heroText: { marginTop: 5, color: '#BFC8D5', ...partnerTheme.typography.caption },
  ...
  progressWrap: { marginTop: 14, paddingTop: 12, flexDirection: 'row', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: partnerTheme.colors.line },
  ...
  attention: { marginTop: 12, flexDirection: 'row', alignItems: 'flex-start', gap: 7, borderRadius: 11, padding: 10, backgroundColor: partnerTheme.colors.warningSoft },
