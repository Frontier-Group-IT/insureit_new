...
export default function PulseScreen() {
  ...
  return (
    <PartnerScreen
      ...
      action={
        <PartnerIconButton icon="close" label="Close business pulse" onPress={() => router.back()} />
      }
    >
      {loading ? (
...
const styles = StyleSheet.create({
  ...
  heroTitle: { marginTop: 5, color: '#FFFFFF', fontSize: 24, fontWeight: '800' },
  heroText: { marginTop: 5, maxWidth: 310, color: '#C9D0DE', fontSize: 10.5, lineHeight: 16 },
  section: { marginTop: 14 },
  sectionTitle: { marginBottom: 7, color: partnerTheme.colors.ink, fontSize: 14, fontWeight: '800' },
  row: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 11, paddingHorizontal: 12, borderRadius: 16, backgroundColor: partnerTheme.colors.surface, borderWidth: 1, borderColor: partnerTheme.colors.line, marginBottom: 8 },
  rowIcon: { width: 34, height: 34, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: partnerTheme.colors.brandSoft },
  rowBody: { flex: 1 },
  ...
  nextButton: { alignSelf: 'flex-start', marginTop: 9, minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 11, paddingHorizontal: 13, backgroundColor: partnerTheme.colors.brandStrong },
