...
const styles=StyleSheet.create({
  hero:{borderRadius:partnerTheme.radius.xl,padding:15,backgroundColor:partnerTheme.colors.nav},heroArtwork:{width:42,height:42},heroTitle:{marginTop:6,color:'#FFFFFF',fontSize:18,fontWeight:'800'},
