...
const styles=StyleSheet.create({
  ...
  attentionList:{gap:8},attentionCard:{minHeight:60,flexDirection:'row',alignItems:'center',gap:10,borderRadius:16,paddingHorizontal:13,backgroundColor:'#FFF9EE',borderWidth:1,borderColor:'#F5DFC1'},attentionIcon:{width:38,height:38,alignItems:'center',justifyContent:'center'},attentionArtwork:{width:36,height:36},attentionBody:{flex:1},attentionTitle:{color:partnerTheme.colors.ink,fontSize:10.5,fontWeight:'800'},attentionText:{marginTop:3,color:'#806B52',fontSize:8.5,lineHeight:13},
