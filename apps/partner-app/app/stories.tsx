...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#101827', paddingTop: 46, paddingHorizontal: 18, paddingBottom: 24 },
  top: { zIndex: 4 },
  ...
  header: { marginTop: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ...
  content: { zIndex: 2, flex: 1, justifyContent: 'center', paddingHorizontal: 6, paddingBottom: 58 },
  storyIcon: { width: 52, height: 52, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
  ...
  eyebrow: { marginTop: 20, color: '#AAA5FF', fontSize: 9, fontWeight: '900', letterSpacing: 1.4 },
  metric: { marginTop: 10, color: '#FFFFFF', fontSize: 36, fontWeight: '900', letterSpacing: -0.8 },
  title: { marginTop: 9, maxWidth: 340, color: '#FFFFFF', fontSize: 25, lineHeight: 32, fontWeight: '900' },
  body: { marginTop: 12, maxWidth: 330, color: '#B7C0CF', fontSize: 11, lineHeight: 18 },

  storyProgressWrap: { marginTop: 22, maxWidth: 330 },
  ...
  completedPill: { alignSelf: 'flex-start', marginTop: 20, minHeight: 34, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 999, paddingHorizontal: 11, backgroundColor: '#18382D' },
