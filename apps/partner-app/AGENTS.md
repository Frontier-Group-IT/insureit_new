...
Read `../../docs/PARTNER_APP_HANDOFF_2026_09_13.md` and `../../docs/PARTNER_APP_PRODUCTION_REFINEMENT_MASTER_PLAN.md` before Partner work.
...
Update `../../docs/PARTNER_APP_HANDOFF_2026_09_13.md` after any material Partner runtime, compatibility-source, native-build, OTA, or user-visible milestone.
