...
3. add explicit IT-only Pause / Resume controls only after exact provider lifecycle endpoints are verified
...
The intended architecture remains CRM-driven streaming rather than CSV-driven normal operation.
