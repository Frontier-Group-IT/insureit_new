...
| 4 — Data/cache/offline/auth lifecycle | READY FOR REVIEW | No | PR #817 merged; preview OTA published; installed-device review pending |
...
**READY FOR REVIEW:** Phase 4 implementation merged in PR #817 as `fd0af36e964a589bf9ce3175f5b36d86ad6e1103`. Exact-head Partner Verify #51 (`33310669425`) passed release identity, route integrity, TypeScript, lint and Expo web review export on head `88acdcbc00f8a3757039c5143ae25628d2107a9b`. Web portal verification run `33310669469` also passed regressions, typecheck, lint and production build. Phase 4 adds identity-scoped in-memory query caching, request deduplication, stale/offline fallback classification, virtualized/paged Customers, Policies, Claims and Renewals, cached Home/Business workspaces, and foreground/background auth/session refresh behavior without native dependencies or offline writes. Partner preview OTA run `33311046411` succeeded on project `8ade82c1-4c96-4f09-b90b-802270fb406d`, branch `preview`, runtime `0.1.0`, update group `7a521fc7-1d1d-4528-a5a7-0d3c7051c64c`, exact Git commit `fd0af36e964a589bf9ce3175f5b36d86ad6e1103`. Remaining gate: installed-device verification of cached navigation, virtualized list loading, pull-to-refresh, filter/search retention and foreground/offline recovery. Phase 5 remains locked until that review is confirmed.
