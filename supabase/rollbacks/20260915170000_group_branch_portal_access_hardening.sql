...
-- Roll back only the 20260915170000 hardening layer. This intentionally
-- restores the pre-hardening PR #1827 runtime contract and keeps all existing
-- Group/Branch portal mappings and Auth users intact.
