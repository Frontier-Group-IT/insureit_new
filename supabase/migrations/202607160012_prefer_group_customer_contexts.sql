-- Prefer direct Group accounts in the mobile context picker.
-- This keeps Group logins on the Group dashboard even if the profile also has
-- an older direct Individual/Corporate customer record.
...
as $$
  ...
  order by
    case
      ...
      when combined_contexts.access_source = 'direct' then 1
      else 2
    end,
