-- Make claim notification titles reflect the actual event when the claim
-- status did not change. This keeps normal status-transition titles unchanged
-- while avoiding repeated titles such as "EXT/1046: Claim Complete" for
