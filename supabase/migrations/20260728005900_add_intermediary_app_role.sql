-- PostgreSQL enum values must be committed before later statements can use them.
-- Run this migration separately before 20260728010000_add_intermediary_portal_access.sql.
