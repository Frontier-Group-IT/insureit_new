  ...
  for v_col in
    ...
    where c.table_schema = 'public'
      ...
      and c.column_name in (
        'id','application_id','partner_code','partner_kind','partner_type','requested_type',
...
-- Repair all active legacy Partner applications that were left unlinked by the
-- earlier migration because partner_kind was mandatory in the live schema.
do $$
declare
  v_row record;
begin
