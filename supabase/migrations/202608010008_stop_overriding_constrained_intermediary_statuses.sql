...
begin
  ...
  -- Only supply identity fields and the known-valid account status here.
  -- Constrained workflow fields such as iib_status, compliance_status and
  -- portal_access_status are intentionally omitted so the table's canonical
  -- defaults/triggers choose values that satisfy the live schema constraints.
