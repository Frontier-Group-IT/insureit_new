...
begin
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    'policy_product', ranked.policy_product,
    'vehicle_segment', ranked.vehicle_segment,
    'production_count', ranked.production_count,
    'policies_with_pdf', ranked.policies_with_pdf
