...
create function public.partner_app_list_claims(
...
begin
  ...
  with base as (
    select
      ...
      cl.policy_service_source::text as policy_service_source,
      cl.customer_id,
...
comment on function public.partner_app_list_claims(integer,integer,text,text) is
  'Returns Partner-scoped claims including the canonical claims.policy_service_source used by Operations to classify internal versus external claims.';
