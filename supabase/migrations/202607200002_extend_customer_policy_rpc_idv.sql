-- Allow mobile vehicle onboarding to optionally create a policy with IDV.

drop function if exists public.create_customer_policy(uuid, uuid, uuid, text, text, date, date, numeric);
