...
values
  ('Royal Sundaram General Insurance Company Limited', 'general', 'BR502821 / BA519545', 'https://ilounge.royalsundaram.in/iPolicyMotor/login', 'configured', true, now()),
  ...
  ('Bandhan Life Insurance Company Limited', 'life', '30000163', null, 'not_provided', true, now()),
  ('HDFC Life Insurance Company Limited', 'life', 'CWB20902', null, 'not_provided', true, now()),
  ('Pramerica Life Insurance Company Limited', 'life', 'BRR391', null, 'not_provided', true, now()),
...
join (values
  ('Royal Sundaram General Insurance Company Limited', 'Royal Sundaram', 'legacy_master'),
  ...
  ('Bandhan Life Insurance Company Limited', 'Bandhan Life', 'legacy_master'),
  ('HDFC Life Insurance Company Limited', 'Hdfc Life', 'legacy_master'),
  ('Pramerica Life Insurance Company Limited', 'Pramerica Life', 'legacy_master'),
