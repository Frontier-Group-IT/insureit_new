...
begin
  ...
  -- Canonical Partner/Employee identity now includes active Partner associate accounts
  -- and still falls back to the preserved legacy Partner/Employee identity contract.
